...
namespace Inlamning2Mvc.Controllers
{
    public class ProfileEntitiesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,Address,ZipCode,City,Country,UserId")] ProfileEntity profileEntity)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,Address,ZipCode,City,Country,UserId")] ProfileEntity profileEntity)
        {
