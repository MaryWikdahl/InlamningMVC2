...
namespace Inlamning2Mvc.Models.Form
{
    public class SignUp
    {
        ...
        [StringLength(256, ErrorMessage = "Must contain a minimum of 2 characters", MinimumLength = 2)]
        ...
        [Required(ErrorMessage = "This field is required")]
        [StringLength(256, ErrorMessage = "Must contain a minimum of 2 characters", MinimumLength = 2)]
        [RegularExpression(@"^([a-öA-Ö]+?)([\s][0-9]+)*?$", ErrorMessage = "This is not a valid streetname")]
        public string Address { get; set; } = "";

        [Display(Name = "Postal code")]
        [Required(ErrorMessage = "This field is required")]
        [StringLength(256, ErrorMessage = "Must contain 5 digits and a whitespace", MinimumLength = 5)]
        [RegularExpression(@"^\d{3}(\s\d{2})?$", ErrorMessage = "This is not a valid postal code (eg. 123 45)")]
